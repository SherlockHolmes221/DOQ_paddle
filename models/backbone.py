...
class IntermediateLayerGetter(paddle.nn.LayerDict):
...
class BackboneBase(paddle.nn.Layer):
    ...
    def __init__(self, backbone: paddle.nn.Layer, train_backbone: bool, num_channels: int, return_interm_layers: bool):
        super().__init__()
